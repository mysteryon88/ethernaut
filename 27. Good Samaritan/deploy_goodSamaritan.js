...
async function main() {
  ...
  const HackGoodSamaritan = await hre.ethers.getContractFactory("HackGoodSamaritan");
  ...
  const posSamaritan = ethers.utils.solidityKeccak256(["uint256", "uint256"], [addrWallet, 0])
  const posHacker = ethers.utils.solidityKeccak256(["uint256", "uint256"], [hackGoodSamaritan.address, 0])
